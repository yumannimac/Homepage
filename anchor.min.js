        ...
        this.add = function(A) {
            ...
            for (i(), o = document.querySelectorAll("[id]"), s = [].map.call(o, function(A) {
                ...
                if (this.hasAnchorJSLink(n[r]))
                    ...
                    "" === this.options.icon && (d.style.font = "1em/1 anchorjs-icons", "left" === this.options.placement && (d.style.lineHeight = "inherit")),
                    "left" === this.options.placement ? (d.style.position = "absolute", d.style.marginLeft = "-1em", d.style.paddingRight = "0.5em", n[r].insertBefore(d, n[r].firstChild)) : (d.style.paddingLeft = "0.375em", n[r].appendChild(d))
                }
